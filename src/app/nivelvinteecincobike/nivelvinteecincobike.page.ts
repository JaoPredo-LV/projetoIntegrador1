...
@Component({
  selector: 'app-nivelvinteecincobike',
  templateUrl: './nivelvinteecincobike.page.html',
  styleUrls: ['./nivelvinteecincobike.page.scss'],
  standalone: true,
  imports: [IonContent, IonIcon,IonBackButton, IonButton, IonButtons,IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
export class NivelvinteecincobikePage implements OnInit, OnDestroy {

  tempoDoTreino: number = 0;
  progressoPorcentagem: number = 0;
  private intervalo: any;
  alturasFinais: number[] = [70, 100, 60, 90, 100, 80, 65, 85, 95];
