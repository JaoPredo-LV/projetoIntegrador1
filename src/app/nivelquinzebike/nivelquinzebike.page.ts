...
@Component({
  selector: 'app-nivelquinzebike',
  templateUrl: './nivelquinzebike.page.html',
  styleUrls: ['./nivelquinzebike.page.scss'],
  standalone: true,
  imports: [IonContent, IonIcon,IonBackButton, IonButton, IonButtons,IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
export class NivelquinzebikePage implements OnInit, OnDestroy {
