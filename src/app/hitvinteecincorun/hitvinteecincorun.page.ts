...
@Component({
  selector: 'app-hitvinteecincorun',
  templateUrl: './hitvinteecincorun.page.html',
  styleUrls: ['./hitvinteecincorun.page.scss'],
  standalone: true,
...
export class HitvinteecincorunPage implements OnInit {
  niveis = [
    { numero: 0, titulo: 'Muito Fácil', link: '/hitrun' },
