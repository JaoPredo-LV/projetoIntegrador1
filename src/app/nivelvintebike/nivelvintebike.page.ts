...
@Component({
  selector: 'app-nivelvintebike',
  templateUrl: './nivelvintebike.page.html',
  styleUrls: ['./nivelvintebike.page.scss'],
  standalone: true,
  imports: [IonContent, IonIcon,IonBackButton, IonButton, IonButtons,IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
export class NivelvintebikePage implements OnInit, OnDestroy {
