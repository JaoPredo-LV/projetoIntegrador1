...
@Component({
  selector: 'app-hitvinteecincoesteira',
  templateUrl: './hitvinteecincoesteira.page.html',
  styleUrls: ['./hitvinteecincoesteira.page.scss'],
  standalone: true,
...
export class HitvinteecincoesteiraPage implements OnInit {
 niveis = [
