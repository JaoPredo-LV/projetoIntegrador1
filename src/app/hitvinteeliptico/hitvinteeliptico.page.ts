...
@Component({
  selector: 'app-hitvinteeliptico',
  templateUrl: './hitvinteeliptico.page.html',
  styleUrls: ['./hitvinteeliptico.page.scss'],
  standalone: true,
...
export class HitvinteelipticoPage implements OnInit {
  niveis = [
