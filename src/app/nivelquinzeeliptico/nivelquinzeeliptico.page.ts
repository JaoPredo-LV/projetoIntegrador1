...
@Component({
  selector: 'app-nivelquinzeeliptico',
  templateUrl: './nivelquinzeeliptico.page.html',
  styleUrls: ['./nivelquinzeeliptico.page.scss'],
  standalone: true,
  imports: [IonContent, IonIcon,IonBackButton, IonButton, IonButtons,IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
export class NivelquinzeelipticoPage implements OnInit, OnDestroy {
