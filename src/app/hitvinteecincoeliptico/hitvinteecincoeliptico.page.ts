...
@Component({
  selector: 'app-hitvinteecincoeliptico',
  templateUrl: './hitvinteecincoeliptico.page.html',
  styleUrls: ['./hitvinteecincoeliptico.page.scss'],
  standalone: true,
...
export class HitvinteecincoelipticoPage implements OnInit {
  niveis = [
