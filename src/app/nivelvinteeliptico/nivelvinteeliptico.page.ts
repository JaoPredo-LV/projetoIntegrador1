...
@Component({
  selector: 'app-nivelvinteeliptico',
  templateUrl: './nivelvinteeliptico.page.html',
  styleUrls: ['./nivelvinteeliptico.page.scss'],
  standalone: true,
  imports: [IonContent, IonIcon,IonBackButton, IonButton, IonButtons,IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
export class NivelvinteelipticoPage implements OnInit, OnDestroy {
