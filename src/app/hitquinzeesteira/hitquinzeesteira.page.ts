...
@Component({
  selector: 'app-hitquinzeesteira',
  templateUrl: './hitquinzeesteira.page.html',
  styleUrls: ['./hitquinzeesteira.page.scss'],
  standalone: true,
...
export class HitquinzeesteiraPage implements OnInit {
 niveis = [
